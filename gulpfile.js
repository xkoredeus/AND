...
gulp.task('video', function () {
  return gulp.src('src/assets/video/**/*.+(mp4|mov|webm)')
...
gulp.task('default', ['clean:dist', 'font', 'scripts', 'images', 'video', 'compile-html', 'resetPages', 'watch']);

// Creates production ready assets in dist folder
gulp.task('build', function () {
    console.log('Building production ready assets');
    runSequence('clean:dist', 'sass', ['scripts', 'images', 'video', 'font', 'compile-html'])
});
